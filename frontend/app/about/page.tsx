        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { name: "Nahar", role: "Outreach Lead", bio: "I love creating tools that help people discover and engage with their communities. In my role as Outreach Lead, I work to connect Locora with local businesses and organizations to ensure our guide is comprehensive and inclusive." },
